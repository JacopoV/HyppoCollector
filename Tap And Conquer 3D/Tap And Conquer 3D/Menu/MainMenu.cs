...
using HyppoCollector.Resources;
using HyppoCollector.PersistentState;


namespace HyppoCollector.Menu
{
    public class MainMenu : Microsoft.Xna.Framework.DrawableGameComponent
    {
        ...
        protected override void LoadContent()
        {
            ...
            res_rect = new Rectangle(midd_w - (int)(font36.MeasureString(Strings.ResumeGame).X / 2.0f),
                150, (int)font36.MeasureString(Strings.ResumeGame).X, (int)font36.MeasureString(Strings.ResumeGame).Y);
            ...
            new_gam_rect = new Rectangle(midd_w - (int)(font36.MeasureString(Strings.NewGame).X / 2.0f),
                230, (int)font36.MeasureString(Strings.NewGame).X, (int)font36.MeasureString(Strings.NewGame).Y);
            ...
            hig_sc_rect = new Rectangle(midd_w - (int)(font36.MeasureString(Strings.HighScores).X / 2.0f),
                310, (int)font36.MeasureString(Strings.HighScores).X, (int)font36.MeasureString(Strings.HighScores).Y);
